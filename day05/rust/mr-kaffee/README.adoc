...
To iterate over the points, I calculate deltas ``dx`` and ``dy`` that define the difference int the x and y coordinate from one point to the next. They can be one of 0, 1, or -1. 
