...
//fun main(args: Array<String>) {
	...
	var snailFishNumberFirst = mutableListOf<Int>()
	var snailFishNumLevFirst = mutableListOf<Int>()
	var levelCount: Int = 0
	var startAddition: Boolean = false
	var largestMagnitude: Int = 0
	...
	File("day2118_puzzle_input.txt").forEachLine {
		...
		snailFishNumberFirst.clear()
		snailFishNumLevFirst.clear()
		...
		it.forEach {
			if (it == '[') {
				...
				snailFishNumberFirst.add(it.toString().toInt())
				snailFishNumLevFirst.add(levelCount)
			}
		}
		println("add: $it + ")
		...
		n= 0
		File("day2118_puzzle_input.txt").forEachLine {
			snailFishNumber.clear()
			snailFishNumLev.clear()
			snailFishNumber.addAll(snailFishNumberFirst)
			snailFishNumLev.addAll(snailFishNumLevFirst)
			...
			if (snailFishNumber[0] > largestMagnitude && m != n) {
				largestMagnitude = snailFishNumber[0]

			}
		}
	}

	solution2 = largestMagnitude
	// end:snailFishMath2[]
