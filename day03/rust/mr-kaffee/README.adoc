...
I wrote a filter function to reduce the list of values step by step until only one is left. Whether oxygen or co2 ratings are calculated is controlled with a ```invert``` flag
[source,rust,numbered]
----
