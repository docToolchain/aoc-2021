...
TIP: Find the full puzzle https://adventofcode.com/2021/day/3
...
[source,rust,numbered]
....
include::src/util.rs[tag=count-bits]
....

[source,rust,numbered]
....
include::src/util.rs[tag=power-consumption]
....
...
[source,rust,numbered]
....
include::src/util.rs[tag=filter-by-strategy]
....
