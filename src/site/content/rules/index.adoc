...
Don't be shy and follow our invitation to our https://join.slack.com/t/slack-dwj2089/shared_invite/zt-zi9wmzxc-Z05uAmczaY0cb4r1ff9Yeg[aoc-2021 Slack channel].
...
The best solution will be to use https://gitpod.io. Just prefix the URL of your GitHub fork with `https://gitpod.io#` e.g. `https://gitpod.io#https://github.com/rdmueller/aoc-2021` or click the button:

image:https://gitpod.io/button/open-in-gitpod.svg[link="https://gitpod.io#https://github.com/rdmueller/aoc-2021", title="Open in Gitpod"] [small]#(if you've forked the repository, the button will still open the master)#
...
Please, take a look at the https://github.com/docToolchain/aoc-2021/tree/master/day00[`day00`] examples.
...
PS: if you like adventofcode.com, consider to https://adventofcode.com/2021/support[sponsor Eric Wastl]
