...
Don't be shy and follow our inventation to our https://join.slack.com/t/aoc-2020/shared_invite/zt-jpb3ukqo-t5amJownVL82CoRrrPNjEg[aoc-2020 Slack channel].
...
The best solution will be to use https://gitpod.io. Just prefix the URL of your GitHub fork with `https://gitpod.io#` e.g. `https://gitpod.io#https://github.com/rdmueller/aoc-2020` or click the button:

image:https://gitpod.io/button/open-in-gitpod.svg[link="https://gitpod.io#https://github.com/rdmueller/aoc-2020", title="Open in Gitpod"] [small]#(if you've forked the repository, the button will still open the master)#
...
Please, take a look at the https://github.com/docToolchain/aoc-2020/tree/master/day00[`day00`] examples.
...
PS: if you like adventofcode.com, consider to https://adventofcode.com/2020/support[sponsor Eric Wastl]
